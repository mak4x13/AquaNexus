      ...
      <div className="grid gap-3">
        <div className="relative h-60 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/80 via-slate-900/50 to-slate-950/80">
          ...
          <div className="absolute bottom-3 left-4 text-xs uppercase tracking-[0.3em] text-slate-400">
            Agent routing intensity
          </div>
        </div>
        <div className="rounded-xl border border-white/10 bg-slate-950/50 px-3 py-2 text-[11px] text-slate-300">
          <p className="uppercase tracking-[0.2em] text-slate-400">Agents</p>
          <p>Source: Climate + Reservoir</p>
          <p>Hub: Policy allocator</p>
          <p>Sinks: Farm agents by province</p>
        </div>
      </div>
    </GlassPanel>
  );
